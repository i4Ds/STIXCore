...
@pytest.mark.skip(reason="Need to figure out test data")
def test_process_request(monkeypatch, tmp_path):
    ...
    request = Path("/Users/shane/Projects/STIX/LLDP/top_input/STIX/requests/request_20210412_183337_183_detected")
    out = tmp_path
    process_request(request, out)


@pytest.mark.skip(reason="Need to figure how to mock environment variables")
