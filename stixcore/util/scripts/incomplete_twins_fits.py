...
def incomplete_twins(args):
    ...
    parser.add_argument("-m", "--move_twin",
                        help="should the matched twin FITS moved",
                        default=False,
                        action='store_true', dest='move_twin')

    parser.add_argument("--twin_target",
                        help="target dir where the twin FITS is moved",
                        default=None, dest='target_dir')
