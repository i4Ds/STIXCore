...
def find_fits(args):
    ...
    parser = argparse.ArgumentParser(
        description="STIX find fits files by properties", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
    ...
    parser.add_argument(
        "-l",
        "--include_levels",
        help="what levels should be found",
        type=str,
    ...
    parser.add_argument(
        "-p",
        "--include_products",
        help="what products should be found",
        type=str,
        default=CONFIG.get("Publish", "include_products", fallback="21,ql,hk,sci,aux,cal"),
    )

    parser.add_argument("-s", "--start_obt", help="start onboard time", default=0, type=int)

    parser.add_argument("-e", "--end_obt", help="end onboard time", default=2 ^ 32, type=int)
    ...
    parser.add_argument(
        "-c", "--copy", help="copy the found files into that dir", type=str, default=None, dest="copy_dest"
    )
