...
class MiniReport(HKProduct, L2Mixin):
    ...
    def is_datasource_for(cls, *, service_type, service_subtype, ssid, **kwargs):
        return kwargs["level"] == "L2" and service_type == 3 and service_subtype == 25 and ssid == 1
...
class MaxiReport(HKProduct, L2Mixin):
    ...
    @classmethod
    def is_datasource_for(cls, *, service_type, service_subtype, ssid, **kwargs):
        return kwargs["level"] == "L2" and service_type == 3 and service_subtype == 25 and ssid == 2
