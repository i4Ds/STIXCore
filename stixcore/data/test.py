...
class IDBTestProduct:
    def __init__(self, data_dir):
        ...
        self.L0_LightCurve_fits = [
            self.DIR / "solo_L0_stix-ql-lightcurve_0664070400_V01.fits",
            self.DIR / "solo_L0_stix-ql-lightcurve_0664156800_V01.fits",
        ]
        self.L1_LightCurve_fits = [
            self.DIR / "solo_L1_stix-ql-lightcurve_20210117_V01.fits",
...
class TMTCTestData:
    def __init__(self, data_dir):
        ...
        self.XML_TM = [
            self.TM_DIR / "Test2.PktTmRaw.xml",
