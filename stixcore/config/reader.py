...
def float_def(value, default=np.inf):
    ...
    default : `double`, optional
        default value to return in case of parsing errors, by default numpy.inf
...
def int_def(value, default=0):
    ...
    default : `int`, optional
        default value to return in case of parsing errors, by default 0
...
def get_sci_channels(date):
    ...
    if SCI_INDEX is None:
        ...
        sci_chan_index_file = Path(root, *["config", "data", "common", "detector", "science_echan_index.csv"])
