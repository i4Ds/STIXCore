...
__all__ = ['FlareListManager']

logger = get_logger(__name__)


class FlareListManager(metaclass=Singleton):
    ...
    def __init__(self, file, update=False):
        ...
        self.file = file
        self.update = update
        self.rid_lut = FlareListManager.read_rid_lut(self.file, self.update)
    ...
    def update_lut(self):
        ...
        """
        self.rid_lut = FlareListManager.read_rid_lut(self.file, update=self.update)
...
if 'pytest' in sys.modules:
    ...
    FlareListManager.instance = FlareListManager(test_data.rid_lut.RID_LUT, update=False)
